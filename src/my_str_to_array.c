...
int args_count(char const *arg, char const *sep)
{
    int count = 0;
...
int args_get_position(char const *arg, char const *sep, int index)
{
    int i = 0;
    int count = -1;
...
char *args_wrap(char const *arg, char const *sep, int index)
{
    int length = 0;
